...
import 'investorsales_model.dart';
export 'investorsales_model.dart';

class InvestorsalesWidget extends StatefulWidget {
  const InvestorsalesWidget({Key? key}) : super(key: key);

  @override
  _InvestorsalesWidgetState createState() => _InvestorsalesWidgetState();
}

class _InvestorsalesWidgetState extends State<InvestorsalesWidget>
    with TickerProviderStateMixin {
  late InvestorsalesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InvestorsalesModel());
                                                                                ...
                                                                                Row(
                                                                                  ...
                                                                                  children: [
                                                                                    Padding(
                                                                                      ...
                                                                                      child: Text(
                                                                                        containerBusinessRecord.businesseval.toString(),
                                                                                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                              fontFamily: 'Readex Pro',
                                                                                              fontSize: 17.0,
                                                                                              fontWeight: FontWeight.bold,
                                                                                    ...
                                                                                    Padding(
                                                                                      ...
                                                                                      child: Column(
                                                                                        ...
                                                                                        children: [
                                                                                          Text(
                                                                                            formatNumber(
                                                                                              columnInvestmentsRecord.tosell,
