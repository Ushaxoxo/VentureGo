...
import 'businesspage_model.dart';
export 'businesspage_model.dart';
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final businesspageUsersRecord = snapshot.data!;
                ...
                context.pushNamed(
                  ...
                  queryParameters: {
                    'chatUser': serializeParam(
                      businesspageUsersRecord,
                      ParamType.Document,
                    ),
                  }.withoutNulls,
                  extra: <String, dynamic>{
                    'chatUser': businesspageUsersRecord,
                  },
                );
              },
                              ...
                              child: RichText(
                                ...
                                text: TextSpan(
                                  children: [
                                    ...
                                    TextSpan(
                                      text: businesspageUsersRecord.displayName,
                                      style: TextStyle(),
                                    )
                                  ],
                                  style: FlutterFlowTheme.of(context)
