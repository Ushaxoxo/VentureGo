...
import 'list_business_model.dart';
export 'list_business_model.dart';

class ListBusinessWidget extends StatefulWidget {
  const ListBusinessWidget({Key? key}) : super(key: key);
...
class _ListBusinessWidgetState extends State<ListBusinessWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListBusinessModel());
                              ...
                              return SingleChildScrollView(
                                child: Column(
                                  ...
                                  children: List.generate(
                                      columnBusinessRecordList.length,
                                      (columnIndex) {
                                                                    ...
                                                                    children: [
                                                                      RichText(
                                                                        ...
                                                                        text:
                                                                          ...
                                                                          children: [
                                                                            TextSpan(
                                                                              text: columnBusinessRecord.name,
                                                                            ...
                                                                            TextSpan(
                                                                              text: columnBusinessRecord.location,
                                                                              style: TextStyle(),
                                                                            )
                                                                          ],
                                                                          style:
                                                                  ...
                                                                  Expanded(
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        percent:
                                                                            columnBusinessRecord.fundraised /
                                                                                columnBusinessRecord.fundrequired,
                                                                        width:
                                                                            350.0,
                                                                        lineHeight:
                                                                            7.0,
